    ...
    <div className="gradbg">
      <nav className="desktop_nav">
        ...
        <ul className="nav_links">
          ...
          <li className="link">
            <a href="typing-test.html" className="active">
              Tests
            </a>
          </li>
          <li className="link">
      ...
      <div className="typing-test-container">
        ...
        <h1 className="typing-test-title">{testName}</h1>
        ...
        <div className="stats">
          <p>
            Ошибки: <span id="error-count">{errorCount}</span>
          </p>
          <p>
            Введено символов: <span id="typed-count">{typedChars}</span>
          </p>
          <p>
            Оставшееся время: <span id="time-left">{timeLeft}</span> сек
          </p>
          <p>
            Точность:{" "}
            <span id="accuracy">
